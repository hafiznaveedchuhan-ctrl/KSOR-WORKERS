...
async def run_triage_agent(query: str, session_id: str) -> tuple[str, str]:
    ...
    async with MCPServerStreamableHttp(
        ...
        refund_specialist = Agent(
            ...
            # No extra prompt text for request_refund: a submission-instructions addendum
            # made this specialist decline "When will I get my refund?" 6/6 (found by
            # the golden eval, docs/adr/007). The tool's own docstring is enough.
